    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5">
            ...
            <ul className="space-y-3 text-sm text-gray-300 font-medium">
              <li className="flex items-center gap-3">
                <span className="w-5 h-5 rounded-full bg-emerald-500/20 text-emerald-400 flex itemes-center justify-center text-xs">
                  ✓
                </span>
          ...
          <div className="lg:col-span-7 bg-[#030712] border border-indigo-900/60 rounded-2xl p-6 shadow-indigo-950/50 font-mono text-xs text-gray-300">
